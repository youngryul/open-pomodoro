            ...
            <div className="flex flex-col items-center justify-center  w-[480px] h-screen mx-auto">
                ...
                <AnimatePresence>
                    <div className="flex flex-row mt-24">
                        <motion.div
                            className="w-[120px] h-[200px] bg-white shadow-lg rounded-lg text-teal-400 flex items-center justify-center text-5xl font-bold"
                            variants={BoxVar}
                            initial="start"
                            animate="end"
                    ...
                    <motion.button
                        onClick={onClick}
                        className="mt-24 w-[100px] h-[100px] bg-black opacity-30 rounded-full text-white text-5xl font-bold"
                        variants={BtnVar}
                        whileHover="hover"
